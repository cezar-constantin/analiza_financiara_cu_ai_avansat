...
const RO = {
  ...
  "home.anom.text":
    "Două lentile pe depunerile publice: verificări de plauzibilitate cu frecvența lor în populație, și corelații și anomalii — radarul de corelații al sectorului, praguri, z-score, regula IQR și reziduuri pe relații, cu scor agregat.",
  "home.open": "Deschide",
  ...
  "a.text":
    "Două lentile pe 1,12 milioane de depuneri. Prima verifică plauzibilitatea unei firme, întotdeauna alături de frecvența problemei în populație — fără ea, orice verificare produce alarme false. A doua urmărește relațiile: ce merge împreună în sectorul companiei și când acel normal s-a rupt.",
  // ---- lens 2: correlations & anomalies (course lesson 6.2)
  "c.kicker": "Lentila 2",
  "c.title": "Corelații și anomalii",
  "c.help":
    "Nu te uiți la o cifră, te uiți la relații. Corelațiile arată ce este normal împreună în sectorul companiei; anomaliile arată când normalul s-a rupt. Corelația este radar, nu sentință.",
  "c.needCompany": "Caută o companie după CUI ca să calculăm semnalele.",
  "c.noCell": "Sectorul companiei nu are suficiente firme pentru o distribuție de referință.",
  "c.matrix.title": "Radarul de corelații al sectorului",
  "c.matrix.help":
    "Corelația dintre cele zece rate, calculată pe firmele din aceeași diviziune CAEN. Valorile albastre merg împreună, cele portocalii merg invers. Winsorizate la percentilele 1 și 99, ca o singură firmă extremă să nu dicteze rezultatul.",
  "c.matrix.method": "Metodă",
  "c.matrix.spearman": "Spearman (pe ranguri, robust)",
  "c.matrix.pearson": "Pearson (liniar)",
  "c.matrix.strongest": "Perechile cu cea mai mare legătură",
  "c.matrix.pair": "Pereche",
  "c.matrix.corr": "Corelație",
  "c.matrix.reading": "Citire economică",
  "c.matrix.trap":
    "Capcanele obișnuite: sezonalitatea și inflația mișcă mai multe linii simultan, o singură operațiune mare rupe relația pentru un an, iar o reclasificare contabilă mută sume între poziții. Când vezi o corelație ciudat de perfectă, întreabă dacă e mecanism sau e sezon.",
  "c.matrix.signTrap":
    "O capcană pe care o vezi chiar în matrice: „datorii / capitaluri” apare slab și chiar pozitiv corelată cu autonomia financiară, deși mecanic ar trebui să fie puternic negativă. Cauza nu este economică, este aritmetică — la firmele cu capitaluri proprii negative raportul devine negativ și mare, deci se clasează la coada distribuției, alături de firmele cele mai solide. Orice rată al cărei numitor poate schimba semnul se comportă astfel; în analiză, o citești separat, nu într-o matrice de corelații.",
  "c.l1.title": "Nivelul 1 · Praguri simple",
  "c.l1.help":
    "Regulile din lecție, aplicate pe istoricul companiei. „Normalul” este media anilor anteriori disponibili — pe date anuale nu există media pe șase luni, deci aceasta este cea mai apropiată variantă onestă.",
  "c.l1.indicator": "Indicator",
  "c.l1.current": "Anul curent",
  "c.l1.normal": "Normal (media anilor anteriori)",
  "c.l1.dev": "Abatere",
  "c.l1.rule": "Regula",
  "c.l1.signal": "Semnal",
  "c.l2.title": "Nivelul 2 · Deviații statistice (z-score și IQR)",
  "c.l2.help":
    "Aici normalul este o distribuție, nu un prag. Pe date anuale, distribuția companiei ar avea trei observații, deci referința este distribuția firmelor comparabile: aceeași diviziune CAEN și aceeași bandă de mărime.",
  "c.l2.value": "Valoarea companiei",
  "c.l2.mean": "Media grupului",
  "c.l2.sd": "Abaterea standard",
  "c.l2.z": "z-score",
  "c.l2.fences": "Limite IQR (Q1 − 1,5·IQR … Q3 + 1,5·IQR)",
  "c.l2.fenceNote":
    "Regula IQR este simetrică, dar zilele de încasare și de stoc nu pot fi negative, deci limita de jos se afișează tăiată la zero: în practică, numai limita de sus declanșează semnal.",
  "c.l2.verdict": "Verdict",
  "c.l2.normal": "normal",
  "c.l2.anom": "anomalie",
  "c.l2.severe": "anomalie severă",
  "c.l2.outIqr": "în afara limitelor IQR",
  "c.l3.title": "Nivelul 3 · Anomalii pe relații (reziduuri)",
  "c.l3.help":
    "În loc de o variabilă, relația dintre două. Pentru fiecare relație, instrumentul estimează pe sector legătura dintre cele două mărimi și compară valoarea reală a companiei cu cea prezisă. Estimarea se face în logaritmi, pentru că firmele din același sector diferă cu câteva ordine de mărime.",
  "c.l3.group": "Grup de referință",
  "c.l3.wideGroup":
    "Banda de mărime a companiei nu are suficiente firme, deci relația este estimată pe un grup mai larg; reziduul este mai puțin precis.",
  "c.l3.relation": "Relația",
  "c.l3.actual": "Real",
  "c.l3.pred": "Prezis pe sector",
  "c.l3.resid": "Reziduu",
  "c.l3.fit": "Potrivirea relației",
  "c.l3.excess": "peste normalul sectorului",
  "c.l3.short": "sub normalul sectorului",
  "c.l3.ok": "în tiparul sectorului",
  "c.rel.receivablesOnRevenue": "Creanțe ← Cifra de afaceri",
  "c.rel.receivablesOnRevenue.r": "Creanțe peste normal înseamnă încasare mai lentă: DSO se lungește, cash-ul se blochează la clienți.",
  "c.rel.inventoriesOnRevenue": "Stocuri ← Cifra de afaceri",
  "c.rel.inventoriesOnRevenue.r": "Stoc peste normal înseamnă cash blocat în depozit: forecast slab, mărfuri cu rotație lentă. Sub normal, posibil stock-out sau vânzări pierdute.",
  "c.rel.debtOnAssets": "Datorii ← Active totale",
  "c.rel.debtOnAssets.r": "Înlocuiește relația furnizori ↔ COGS din lecție, care nu se poate calcula: datele publice nu separă furnizorii de restul datoriilor, nici costul bunurilor vândute de restul cheltuielilor.",
  "c.rel.cashOnRevenue": "Numerar ← Cifra de afaceri",
  "c.rel.cashOnRevenue.r": "Numerar mult sub normalul sectorului, la aceeași activitate, înseamnă buffer subțire.",
  "c.rel.staffOnRevenue": "Salariați ← Cifra de afaceri",
  "c.rel.staffOnRevenue.r": "Abaterile mari arată fie un model de business externalizat, fie salariați raportați la altă entitate din grup.",
  "c.score.title": "Scorul de anomalii",
  "c.score.help":
    "Semnalele se agregă cu ponderile din lecție, pe o scală de la 0 la 100. Un scor bun are întotdeauna primele trei motive la vedere — altfel devine o cifră opacă.",
  "c.score.band.normal": "normal",
  "c.score.band.watch": "atenție",
  "c.score.band.high": "risc ridicat",
  "c.score.top": "Din ce se compune scorul: primele trei contribuții",
  "c.score.none": "Niciun semnal declanșat.",
  "c.score.signal": "Semnal",
  "c.score.weight": "Pondere",
  "c.score.state": "Stare",
  "c.score.missing": "Semnale din lecție care nu se pot calcula pe date publice anuale",
  "c.score.missing.dpo": "DPO (zile de plată a furnizorilor) — datele publice nu separă furnizorii din totalul datoriilor",
  "c.score.missing.line": "Utilizarea liniei de credit peste 80 % — nu există în situațiile financiare",
  "c.score.missing.conc": "Concentrarea pe primul client, combinată cu întârziere — nu există în situațiile financiare",
  "c.score.missing.gross": "Marja brută în sensul comercial — se folosește marja netă, pentru că lipsește costul bunurilor vândute",
  "c.score.maxNote": "Ponderile indisponibile însumează 50 de puncte din scala lecției; scorul afișat provine doar din semnalele calculabile.",
  "c.story": "Povestea în trei propoziții",
  "c.sig.dso": "Zile de încasare a creanțelor (DSO)",
  "c.sig.dio": "Zile de stoc (DIO)",
  "c.sig.cycle": "Ciclul operațional (DSO + DIO)",
  "c.sig.margin": "Marja netă",
  "c.sig.residInv": "Stoc peste normalul sectorului (reziduu > 2σ)",
  "c.sig.residRec": "Creanțe peste normalul sectorului (reziduu > 2σ)",
  "c.sig.red": "roșu",
  "c.sig.yellow": "galben",
  "c.sig.green": "fără semnal",
  "c.sig.na": "indisponibil",
  "c.cycleNote":
    "Ciclul de conversie a numerarului din lecție scade din ciclul operațional zilele de plată a furnizorilor. Aici lipsește componenta de furnizori, deci se afișează ciclul operațional — DSO plus DIO — și regula de 15 zile i se aplică lui.",
...
const EN = {
  ...
  "home.anom.text":
    "Two lenses on public filings: plausibility checks with their frequency in the population, and correlations and anomalies — the sector's correlation radar, thresholds, z-scores, the IQR rule and relationship residuals, with an aggregate score.",
  "home.open": "Open",
  ...
  "a.text":
    "Two lenses on 1.12 million filings. The first checks a company's plausibility, always next to how frequent the issue is in the population — without that, any check produces false alarms. The second follows relationships: what moves together in the company's sector, and when that normal has broken.",
  "c.kicker": "Lens 2",
  "c.title": "Correlations and anomalies",
  "c.help":
    "You do not look at one figure, you look at relationships. Correlations show what is normal together in the company's sector; anomalies show when that normal has broken. Correlation is radar, not a verdict.",
  "c.needCompany": "Look up a company by tax ID so the signals can be computed.",
  "c.noCell": "This company's sector does not have enough firms for a reference distribution.",
  "c.matrix.title": "The sector's correlation radar",
  "c.matrix.help":
    "Correlation between the ten ratios, computed across firms in the same CAEN division. Blue pairs move together, orange pairs move in opposite directions. Winsorised at the 1st and 99th percentiles so a single extreme firm cannot dictate the result.",
  "c.matrix.method": "Method",
  "c.matrix.spearman": "Spearman (rank-based, robust)",
  "c.matrix.pearson": "Pearson (linear)",
  "c.matrix.strongest": "The most strongly linked pairs",
  "c.matrix.pair": "Pair",
  "c.matrix.corr": "Correlation",
  "c.matrix.reading": "Economic reading",
  "c.matrix.trap":
    "The usual traps: seasonality and inflation move several lines at once, a single large transaction breaks the relationship for a year, and an accounting reclassification shifts amounts between line items. When a correlation looks suspiciously perfect, ask whether it is a mechanism or a season.",
  "c.matrix.signTrap":
    "One trap is visible in the matrix itself: “debt / equity” shows up weakly and even positively correlated with the equity ratio, although mechanically it should be strongly negative. The cause is not economic but arithmetic — for firms with negative equity the ratio turns large and negative, so they rank at the bottom of the distribution, next to the soundest firms. Any ratio whose denominator can change sign behaves this way; in analysis you read it on its own, not inside a correlation matrix.",
  "c.l1.title": "Level 1 · Simple thresholds",
  "c.l1.help":
    "The rules from the lesson, applied to the company's own history. “Normal” is the average of the available prior years — annual data has no six-month average, so this is the closest honest substitute.",
  "c.l1.indicator": "Indicator",
  "c.l1.current": "Current year",
  "c.l1.normal": "Normal (average of prior years)",
  "c.l1.dev": "Deviation",
  "c.l1.rule": "Rule",
  "c.l1.signal": "Signal",
  "c.l2.title": "Level 2 · Statistical deviations (z-score and IQR)",
  "c.l2.help":
    "Here normal is a distribution, not a threshold. On annual data the company's own distribution would have three observations, so the reference is the distribution of comparable firms: same CAEN division and same size band.",
  "c.l2.value": "Company value",
  "c.l2.mean": "Group mean",
  "c.l2.sd": "Standard deviation",
  "c.l2.z": "z-score",
  "c.l2.fences": "IQR fences (Q1 − 1.5·IQR … Q3 + 1.5·IQR)",
  "c.l2.fenceNote":
    "Regula IQR este simetrică, dar zilele de încasare și de stoc nu pot fi negative, deci limita de jos se afișează tăiată la zero: în practică, numai limita de sus declanșează semnal.",
  "c.l2.verdict": "Verdict",
  "c.l2.normal": "normal",
  "c.l2.anom": "anomaly",
  "c.l2.severe": "severe anomaly",
  "c.l2.outIqr": "outside the IQR fences",
  "c.l3.title": "Level 3 · Relationship anomalies (residuals)",
  "c.l3.help":
    "Instead of one variable, the relationship between two. For each relationship the tool estimates the sector-wide link between the two magnitudes and compares the company's actual value with the predicted one. The estimation is done in logarithms, because firms in the same sector differ by several orders of magnitude.",
  "c.l3.group": "Reference group",
  "c.l3.wideGroup":
    "The company's size band has too few firms, so the relationship is estimated on a wider group; the residual is less precise.",
  "c.l3.relation": "Relationship",
  "c.l3.actual": "Actual",
  "c.l3.pred": "Sector prediction",
  "c.l3.resid": "Residual",
  "c.l3.fit": "Fit of the relationship",
  "c.l3.excess": "above the sector norm",
  "c.l3.short": "below the sector norm",
  "c.l3.ok": "within the sector pattern",
  "c.rel.receivablesOnRevenue": "Receivables ← Revenue",
  "c.rel.receivablesOnRevenue.r": "Receivables above normal mean slower collection: DSO lengthens and cash is stuck with customers.",
  "c.rel.inventoriesOnRevenue": "Inventories ← Revenue",
  "c.rel.inventoriesOnRevenue.r": "Inventory above normal means cash stuck in the warehouse: weak forecasting, slow movers. Below normal, possible stock-outs or lost sales.",
  "c.rel.debtOnAssets": "Liabilities ← Total assets",
  "c.rel.debtOnAssets.r": "This stands in for the lesson's suppliers ↔ COGS relationship, which cannot be computed: public data separates neither trade payables from other liabilities nor cost of goods sold from other expenses.",
  "c.rel.cashOnRevenue": "Cash ← Revenue",
  "c.rel.cashOnRevenue.r": "Cash well below the sector norm at the same level of activity means a thin buffer.",
  "c.rel.staffOnRevenue": "Employees ← Revenue",
  "c.rel.staffOnRevenue.r": "Large deviations point either to a fully outsourced model or to staff reported under another group entity.",
  "c.score.title": "Anomaly score",
  "c.score.help":
    "Signals are aggregated with the weights from the lesson, on a 0 to 100 scale. A good score always shows its top three reasons — otherwise it becomes an opaque number.",
  "c.score.band.normal": "normal",
  "c.score.band.watch": "watch",
  "c.score.band.high": "high risk",
  "c.score.top": "What makes up the score: the top three contributions",
  "c.score.none": "No signal triggered.",
  "c.score.signal": "Signal",
  "c.score.weight": "Weight",
  "c.score.state": "State",
  "c.score.missing": "Signals from the lesson that annual public data cannot produce",
  "c.score.missing.dpo": "DPO (days payable) — public data does not separate trade payables from total liabilities",
  "c.score.missing.line": "Credit line utilisation above 80 % — not present in financial statements",
  "c.score.missing.conc": "Top-customer concentration combined with late payment — not present in financial statements",
  "c.score.missing.gross": "Gross margin in the commercial sense — net margin is used instead, because cost of goods sold is missing",
  "c.score.maxNote": "The unavailable weights add up to 50 points of the lesson's scale; the score shown comes only from the computable signals.",
  "c.story": "The story in three sentences",
  "c.sig.dso": "Days sales outstanding (DSO)",
  "c.sig.dio": "Days inventory outstanding (DIO)",
  "c.sig.cycle": "Operating cycle (DSO + DIO)",
  "c.sig.margin": "Net margin",
  "c.sig.residInv": "Inventory above the sector norm (residual > 2σ)",
  "c.sig.residRec": "Receivables above the sector norm (residual > 2σ)",
  "c.sig.red": "red",
  "c.sig.yellow": "amber",
  "c.sig.green": "no signal",
  "c.sig.na": "unavailable",
  "c.cycleNote":
    "The cash conversion cycle from the lesson subtracts days payable from the operating cycle. The payables leg is missing here, so the operating cycle — DSO plus DIO — is shown instead, and the 15-day rule applies to it.",
